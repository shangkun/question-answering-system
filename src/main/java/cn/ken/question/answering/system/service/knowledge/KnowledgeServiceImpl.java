...
import cn.ken.question.answering.system.mapper.knowledge.ExtensionQuestionMapper;
...
import cn.ken.question.answering.system.mapper.knowledge.AnswerMapper;
...
//            }
    ...
    public int count(KnowledgeRequest request) throws Exception {
        return knowledgeMapper.countByAttribute(request);
    }
