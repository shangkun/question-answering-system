...
import cn.ken.question.answering.system.mapper.knowledge.LexiconMapper;
...
public class LexiconServiceImpl extends Base implements LexiconService{
    ...
    @Override
    public int countByAttribute(LexiconRequest request) {
        return lexiconMapper.countByAttribute(request);
    }
