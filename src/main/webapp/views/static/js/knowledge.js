...
function onClick(e, treeId, treeNode) {
    request.classificationId=treeNode.id;
}
...
function loadTree(){
    ...
    POST(classificationUrl+"get",request,function(data){
        if(data.statusCode==200){
            ...
            var classificationTree = $.fn.zTree.init($("#classificationTree"), setting, classificationArray);
        }else{
...
function load_knowledge(){
    table = $("#knowledge").DataTable({
        ...
        "ajax": function (data, callback) {
            ...
            POST(knowledgeUrl+"get",request,function(result){
                //封装返回数据
                var returnData = {};
                $("#knowledge_total").html(result.data.total);
        ...
        "columns":[
            ...
            {"data":"modifierName"},
            {
                "data" : "id",
                "render" : function(data,type,row) {
                    var html = '<a style="text-decoration:none" onClick="open_full(\'知识编辑\',\'knowledge-add-update.html?id='+data+'\')" href="javascript:;" title="编辑">' +
                        '<i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="knowledge_del(this,\''+data+'\')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>';
                    return html;
                }
            }
        ]
...
function knowledge_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
        GET(knowledgeUrl+"delete/"+id,null,function(data){
            if(data.statusCode==200){
                table.ajax.reload();
...
function batch_del(){
    ...
    layer.confirm('确认要删除吗？',function(index){
        POST(knowledgeUrl+"batch/delete/",idList,function(data){
            if(data.statusCode==200){
                table.ajax.reload();
                layer.msg(data.message,{icon:1,time:1000});
            }else{
